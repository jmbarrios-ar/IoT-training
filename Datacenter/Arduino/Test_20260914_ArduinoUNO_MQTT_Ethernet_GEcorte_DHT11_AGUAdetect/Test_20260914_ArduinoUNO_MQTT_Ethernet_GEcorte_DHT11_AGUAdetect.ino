...
//************ DETECCIÓN ANALOGICA DE AGUA **************
void aguadeteccion() {
  SENSOR = analogRead(A0);
  if (SENSOR > 0) {
    Serial.println("Se ha detectado agua en el entrepiso de Sala de Comunicaciones. Publicando AGUAS");
    client.publish(topicAgua, "AGUAS"); // Publicando hacia MQTT la deteccion de agua
  }
  else{
    Serial.println("Todo normal, sin agua en el entrepiso de Sala de Comunicaciones");
  }
  delay(1000);
}